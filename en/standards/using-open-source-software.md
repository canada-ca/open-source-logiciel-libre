...
This open core development model, is where vendors only release a portion portions of their software and then surround the remainder with closed-source offerings.
